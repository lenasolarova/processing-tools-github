...
IDENTITY_HEADER = (
    "eyJpZGVudGl0eSI6IHsidHlwZSI6ICJVc2VyIiwgImFjY291bnRfbnVtYmVyIjogIjAwMDAwMDEiLCAib3Jn"
    "X2lkIjogIjAwMDAwMSIsICJpbnRlcm5hbCI6IHsib3JnX2lkIjogIjAwMDAwMSJ9fX0="
)
...
def upload_archive(
    archive_buffer, content_type="application/vnd.redhat.openshift.periodic+tar"
):
